...
{
	if (self = [super initWithNibName:@"DemoPageViewController" bundle:nil]) {
		fImageFileName = [aFileName copy];
    }
    return self;
}
...
- (void)viewDidLoad {
	NSString *imagePath = [[[NSBundle mainBundle] bundlePath] stringByAppendingPathComponent:fImageFileName];
